...
@interface FJSResultSet () {
    NSMutableDictionary *_columnNameToIndexMap;
}
@end

@implementation FJSResultSet

+ (instancetype)resultSetWithStatement:(FJSStatement *)statement usingParentDatabase:(FJSDatabase*)aDB {
    
    FJSResultSet *rs = [[FJSResultSet alloc] init];
