...
@interface FJSDatabaseQueue : NSObject
/** Path of database */
...
- (void)inImmediateTransaction:(__attribute__((noescape)) void (^)(FJSDatabase *db, BOOL *rollback))block;
...
- (NSError * _Nullable)inSavePoint:(__attribute__((noescape)) void (^)(FJSDatabase *db, BOOL *rollback))block;
